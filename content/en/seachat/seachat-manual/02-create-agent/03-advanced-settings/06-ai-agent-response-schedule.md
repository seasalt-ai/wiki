---
title: "AI Agent Response Schedule"
description: "Set a schedule for when the AI Agent should respond to customers — ideal for handling inquiries during off-hours, holidays, or any custom timeframe."
lead: ""
...
toc: true
aliases:
  - /en/seachat/seachat-manual/02-create-agent/03-advanced-settings/06-ai-agent-response-schedule
  - /en/seachat/manual/create-agent/advanced-settings/ai-agent-response-schedule/
url: /en/seachat/manual/create-agent/advanced-settings/ai-agent-response-schedule/
---
