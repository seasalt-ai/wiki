...
Get started by going to the [Facebook Developer Site](https://developers.facebook.com/). Create an account or log in by clicking the green button on the top of the page.
...
1. In the pop-up box, select the Facebook Page that you would like the bot to connect to, and click on Continue. Note: You will need a page for your business on the Facebook site before it will appear here. For instructions on how to create a Facebook page, refer to this guide.
...
4. Return to the SeaChat configuration page (this page), and under the Facebook Access Token field in the form above, paste the token, and submit the form. A webhook URL and verify token will appear. Hold onto this information for the next step.
...
We recommend submitting your bot for verification under the **App Review** section on the dashboard. Follow the steps on the page to submit a request to Facebook. Unverified apps may only send and receive messages to test users.

Your bot is now ready to go live! On the top of the dashboard page, toggle the **App Mode** to **Live**, and your bot will now respond to user messages in the chat box on your Facebook page.
