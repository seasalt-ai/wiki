...
* 如需更詳細的指導，請查閱[SeaChat說明書](/en/seachat/seachat-intro/02-how-to-create/)。如果遇到任何問題或有疑問，我們的[支援團隊](#support)隨時待命協助您。請隨時聯繫我們。
---

在本教學中，我們將從頭開始創建一個SeaChat助理。這個AI助理將幫助回答有關停車場業務的常見問題。我們將引導您完成創建AI助理的過程，向其知識庫添加知識，測試和調整助理，以確保它準備好回答客戶的所有來信問題！
...
> **什麼是工作區？**
>
>  工作區是包含您組織的數據的信息中心，提供您的助理、成員和API金鑰的總覽。您可以選擇為自己創建一個新的工作區，或通過向管理員請求邀請加入現有的一個。

## 步驟2：您的第一個SeaChat助理
點擊**新增AI助理**來配置您的新助理。如果您已經有一個工作區和一個助理，您可以通過點擊位於右上角靠近您個人頭像的下拉選單來創建一個新的。
...
> :bulb: **注意**
>
> 真人助理功能將要求一個客服人員介入，以防客戶希望轉接給一個客服人員。如果您選擇此選項，客戶將有機會在聊天中請求一個人類助理，您應該安排一個客服人員來回應正在進行的對話。
>

## 步驟3：新增知識
為了充分利用您的SeaChat助理的功能，我們需要向其知識庫添加知識。SeaChat為您的助理知識庫上傳內容提供了多種選擇。通過導航到側邊選單中的**知識庫**儀表板，找到您助理的知識庫。

請隨意嘗試不同的數據上傳方式。為了本教學的目的，我們將專注於使用**上傳電子表格**方法。然而，如果您對探索其他數據上傳技術感興趣，我們邀請您查看我們用戶手冊中的[知識庫](/en/seachat/seachat-intro/03-add-knowledge/add-knowledge-intro)部分，以獲取全面的指導和建議。
...
在上傳文件後，我們可以在預覽部分看到每個標題及其對應的數據。現在，我的停車助理現在準備好進行下一步了。

要查看已上傳的停車場數據，我們只需導航到儀表板右上角的**現有知識**部分，一旦您的文件成功上傳即可。
...
就是這樣。現在，我的停車助理已經處理了上傳的數據，讓我們進行測試，看看是否需要進一步調整。點擊位於右下角的**測試AI助理**按鈕。讓我們嘗試與我的停車助理聊天，看看是否可以優化其性能！
...
在我們剛剛建立的AI助理投入使用前，通過測試和調整來訓練它是至關重要的。想象自己是與AI助理互動的客戶。您現在可以開始提問，看看您的SeaChat助理如何回應。

隨著知識庫的更新，我的停車助理現在已經準備好進行測試。在點擊**測試AI助理**後的對話框中，您可以開始提問，看看您的助理如何回應。這是我跟我助理的對話。
...
哎呀，看來我的停車助理需要一些調整。我將在這裡給它一個負評來提供回饋。
...
看起來敦化南路月租停車場的信息並沒出現在我的停車助理的知識庫中。點擊**新增知識庫文章**來新增相關知識。
<br/>
<center>
...
你看！我的停車助理現在給我正確的信息了。就是這麼簡單！您現在可以自己嘗試，看看您的助理表現如何。
...
在本教學中，我們已經引導您完成了設置並微調您的第一個AI助理的步驟。然而，要完全釋放SeaChat AI助理的力量，還有一些方面需要您掌握。我們誠摯地邀請您探索我們詳細的[用戶手冊](/en/seachat/seachat-intro/02-how-to-create/)，以了解SeaChat的真正潛力，或者您可以直接聯繫我們的[支援團隊](#support)獲得更多信息和協助。
