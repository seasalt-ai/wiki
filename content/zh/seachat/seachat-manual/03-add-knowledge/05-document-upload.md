---
title: "上傳文件"
description: "探索如何在SeaChat上將超過20種文件格式，如DOCX、MP3、PNG等，有效地上傳至您AI助理的知識庫，以及如何利用這些文件提升AI助理的回答能力。"
lead: ""
...
url: /zh/seachat/manual/add-knowledge/document-upload/
---
> 🧭 **檔案大小規則**
>
...
>
> 針對圖片文件，例如 png，我們僅支持英文文件。至於音頻文件，我們建議您使用 [音頻/視頻上傳](https://wiki.seasalt.ai/zh/seachat/seachat-manual/03-add-knowledge/03-multimedia-upload/)。
