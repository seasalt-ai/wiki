...
## 簡介
SeaChat 提供許多不同的方式讓您上傳文件到您助理的知識庫中。在本教學中，我們將專注於 **手動輸入** 方法。讓我們以一篇文章為例，向您展示如何手動輸入數據到您的AI助理。
...
## 什麼時候應該使用手動輸入？
當您有一些重要信息想要包含在知識庫中時，您應該選擇手動輸入。這可以是一個簡短的產品描述，或者是一個常見問題。手動輸入還是一種快速排除故障並快速教導 AI 助理一些小技巧的好方法。

## 輸入數據
有很多資料要填寫。我們將不會詳細介紹所有的輸入格，但如果您想了解更多信息，可以查看我們手冊的進階部分。現在，讓我們一次填寫一個輸入格，並將數據新增到我們的助理中。
...
完成後，點擊 **送出** 按鈕將內容上傳到您的助理的知識庫中。SeaChat 將開始導入您提供的信息。


## 送出到現有知識庫
文件成功上傳後，您將看到一個成功的消息。您已成功的為您的 AI 助理程式，增加了新的知識。要查看已上傳的文件，您可以到頁面右上角的 **現有知識** ，在那裡您可以在 **手動輸入** 中找到新的上傳數據。
