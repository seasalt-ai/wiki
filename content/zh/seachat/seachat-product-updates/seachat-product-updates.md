...
lastmod: 2025-01-15T08:48:57+00:00
draft: false
images: []
menu:
  seachat:
...
- GA4 自訂支援: 您現在可以在 代理人資訊 > 設計樣式 > 聊天設定 中直接填入您的 GA4 Measurement ID。設定完成後，SeaChat 將開始將小工具互動資料（如發送訊息、按鈕點擊、轉接真人客服等）傳送至您的 GA4 資產，協助您深入了解使用者行為並監控效能。
- 真人客服轉接方式可自訂: 我們更新了真人客服轉接選項，讓您可以自由選擇觸發轉接的方式。現在您可以選擇：由使用者點擊按鈕提出轉接、在與 AI 對話中表達轉接意圖，或兩者皆可。
- 上傳圖片容量上限提升: 我們已將圖片上傳的容量上限提升至 20MB。您現在可以在對話中上傳更大、更清晰、更高畫質的圖片，分享更方便。
