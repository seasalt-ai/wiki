...
- 修復通訊平台在收到語音訊息時無法進行語音轉寫的問題；目前系統可正常接收語音訊息、完成語音轉文字（STT），並依轉寫結果回覆。

### 1/29/2026

##### **<font color="#739963">新功能與改進</font>**

- 針對「調查（Survey）」使用情境的 AI 智慧助理，提升轉接真人客服功能的識別準確性。

### 1/22/2026

##### **<font color="#d66a60">修正項目</font>**

- 修復在關閉「上下文提取」功能後，對話總結郵件中仍包含上下文提取內容的問題。

### 1/15/2026

##### **<font color="#d66a60">修正項目</font>**

- 修復 SeaX 對話整合頁面中，撥入電話 AI 語音助理語速設定未正確生效的問題。
...
- 優化每月語音機器人使用量報表 Excel 格式：
  - 新增「Company Name」、「Branch Name」、「Uniq ID」欄位
  - 更新 Period 顯示格式為 `YYYY/MM/dd - YYYY/MM/dd`
  - 套用專業版面樣式（強調標題/總計列，並對齊總計標籤）

### 12/17/2025

##### **<font color="#739963">新功能與改進</font>**

- 優化對話捲動：載入較舊訊息時，視窗位置保持不跳動。
